...
results_folder = 'results/experiments/cross/'

pickles_folder = '/media/maindisk/data/hooktheory_hr/guidance_experiment_data/cross/'
...
for subfolder in subfolders:
    ...
    for input_dataset in ['test', 'jazz']:
        ...
        for guide_dataset in ['test', 'jazz']:
            ...
            base_name = '_'.join( [subfolder.replace('/','_'), input_dataset, guide_dataset] )
