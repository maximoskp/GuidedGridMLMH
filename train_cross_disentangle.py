from train_gmlmh_fn import train_cross_disentangle_gmlmh
...
train_dir = '/media/maindisk/data/hooktheory_hr/guidance_disentanglement_data/cross/unf_CA_random'
val_dir = train_dir
